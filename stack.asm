# from https://stackoverflow.com/questions/15690978/how-to-use-system-call-9-sbrk-for-dynamic-memory-allocation-in-mips
.data
	message1: .asciiz "Insira o tamanho do array: "
	message2: .asciiz "Insira os elementos do vetor: "
...
li $v0, 4
    ...
    # multiplicando o tamanho do array por 4 que vai ser a quantidade de memoria utilizada 
...
create_array:    
    ...
    li   $s0, 0         # $s1 is the index, and loop induction variable		i = 0
    li   $s1, 5         # $s1 is the sentinel value for the loopq		i < n
